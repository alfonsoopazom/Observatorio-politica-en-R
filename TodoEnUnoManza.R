...
patHashtag="#[A-Za-z0-9Ã¡Ã©Ã?Ã³Ãº]*"
...
while(i <= numArchivos)
{
  ...
  consulta$text=gsub("<c1>","A",consulta$text)#A
  consulta$text=gsub("<e9>","é",consulta$text)#e
  consulta$text=gsub("<c9>","E",consulta$text)#E
  consulta$text=gsub("<ed>","í",consulta$text)#i
  consulta$text=gsub("<cd>","I",consulta$text)#I
  consulta$text=gsub("<f3>","ó",consulta$text)#o
  consulta$text=gsub("<d3>","O",consulta$text)#O
  consulta$text=gsub("<fa>","ú",consulta$text)#u
  consulta$text=gsub("<da>","U",consulta$text)#U
  ...
  try(plotly_IMAGE(p, format = "png", out_file = 'C:/Users/interbarometro/Desktop/ProgramasR/TodoEnUnoManzanapp/Resultados/Evolucion/Grafico Torta/ReproduccionInteraccionProduccion.png'), silent = TRUE)
  ...
  try(plotly_IMAGE(p, format = "png", out_file = 'C:/Users/interbarometro/Desktop/Observatorio/Manzanapp/Resultados/CaracteristicasTecnicas/Dispositivos/PorcentajeDispositivos.png'), silent = TRUE)
