...
while(i <= numArchivos)
{
  ...
  consulta$text=gsub("<f1>","Ã±",consulta$text)#Ã±
  consulta$text=gsub("<e1>","Ã¡",consulta$text)#a
  consulta$text=gsub("<c1>","Ã",consulta$text)#A
  consulta$text=gsub("<e9>","Ã©",consulta$text)#e
  consulta$text=gsub("<c9>","Ã",consulta$text)#E
  consulta$text=gsub("<ed>","Ã",consulta$text)#i
  consulta$text=gsub("<cd>","Ã",consulta$text)#I
  consulta$text=gsub("<f3>","Ã³",consulta$text)#o
  consulta$text=gsub("<d3>","Ã",consulta$text)#O
  consulta$text=gsub("<fa>","Ãº",consulta$text)#u
  consulta$text=gsub("<da>","Ã",consulta$text)#U
